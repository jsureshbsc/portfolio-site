  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="About Suresh J, Full Stack Web Developer and AI Chatbot Developer building SEO-friendly websites using React, JavaScript, and Spring Boot."
        />
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              >
                Building Digital{" "}
                <span className="text-gradient">Solutions</span> That Drive
                Success
              </motion.h1>
